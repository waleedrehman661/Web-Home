var navbar =document.querySelector("header").innerHTML +=
`
<nav class="navbar navbar-expand-lg px-4 py-3 sticky-top">
            <div class="container-fluid">
              <a class="navbar-brand" href="index.html"><img class="navlogo" src="assets/images/newlogo.png" alt=""></a>
...
`
var navbar =document.querySelector("footer").innerHTML +=
`
 <section>
    <div class="container-fluid">
      <div class="row">
        <div class="footer-left-sidebg col-12 col-lg-4 py-4 py-md-5 py-xxl-8">
          <div class="row h-100 align-items-end justify-content-center">
            <div class="col-12 col-md-11 col-xl-10">
              <div class="footer-logo-wrapper">
                <a href="#!">
                  <img src="./assets/images/newlogo.png" alt="BootstrapBrain Logo" width="179" height="60">
                </a>
              </div>
              <div class="social-media-wrapper mt-5">
                <ul class="nav">
                  <li class="nav-item me-3">
                    <a style="color: #043ba1;" class="nav-link p-2 bg-light rounded" href="#!">
                  ...
                  <li class="nav-item me-3">
                    <a style="color: #dd201a;" class="nav-link link-primary p-2 bg-light rounded" href="#!">
                  ...
                  <li class="nav-item me-3">
                    <a style="color: #3b71d6;" class="nav-link link-primary p-2 bg-light rounded" href="#!">
                  ...
                  <li class="nav-item">
                    <a style="color: #ce154c;" class="nav-link link-primary p-2 bg-light rounded" href="#!">
        ...
        <div class="col-12 col-lg-8 bg-light py-4 py-md-5 py-xxl-8">
          <div class="row justify-content-center">
            <div class="col-12 col-md-11 col-xxl-10">
                  ...
                  <div class="widget">
                    ...
                    <form action="#!">
                      <div class="row gy-4">
                        ...
                        <div class="col-12">
                          <div class="d-grid">
                            <button style="background-color:  #3539b5;" class="btn text-white" type="submit">Subscribe</button>
                          </div>
                        </div>
                      </div>
                    </form>
              ...
              <div class="row mt-4 border-top border-light-subtle">
                <div class="footer-copyright-wrapper mt-5">
                  &copy; 2024. All Rights Reserved.
                </div>
                <div class="credits text-secondary mt-2 fs-7">
                  FOUNDER<a href="https://bootstrapbrain.com/" class="link-secondary text-decoration-none"> OF WEB HOME</a> WALEED REHMAN <span style="color: #3539b5;">&#9829;</span>
                </div>
              </div>
            </div>
          </div>
